...
export default function ElectionIntroSecondSection({
  ...
  return (
    <div className="relative flex w-screen h-[400px] sm:h-[600px] md:h-[800px] xl:h-[600px] bg-white z-2">
      ...
      {/* mobile */}
      <div className="xl:hidden absolute -top-[12.5%] h-fit left-1/2 transform -translate-x-1/2 w-full flex space-x-10 xl:space-x-16 ">
            ...
            {circleData.map(
              (circle, idx) =>
                idx == 0 && (
                  <motion.div
                    key={`${circle.title}-${idx}`}
                    className="xl:hidden flex w-[185px] h-[185px] sm:w-[280px] sm:h-[280px] lg:w-[360px] lg:h-[360px] 2xl:w-[469px] 2xl:h-[469px] rounded-full bg-[rgba(255,255,255,0.80)] shadow-[0px_4px_6px_0px_rgba(128,2,2,0.15)] border-white border-4  flex-col items-center justify-center"
                    initial={{ opacity: 0, y: 40 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{
                      duration: 0.43,

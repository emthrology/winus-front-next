...
export default function ElectionIntroThirdSection({
  ...
  return (
    <div className="relative w-full h-[600px] sm:h-[900px] pt-12 flex flex-col items-start bg-[linear-gradient(180deg,#FFE5E7_0%,#FFF_100%)]">
      {/* 상단 텍스트/버튼 등 */}
      <div className="flex w-full flex-col items-center mt-28 lg:space-y-4">
        <p className="text-[#E93541] text-2xl sm:text-3xl lg:text-5xl font-normal">
          균형있는 업무 분담으로
        </p>
        <p className="text-[#E93541] text-2xl sm:text-3xl lg:text-6xl font-bold">
          선거에 더욱 전문적으로 접근 합니다
        </p>

        <p className="text-[#727272] text-base lg:text-2xl font-[300] pt-2">
      ...
      <div className="flex items-center mx-auto w-fit mt-12">
        {circleData.map((circle, idx) => (
          <div
            key={`${circle.title}`}
            className="flex flex-col items-center w-[100px] sm:w-[170px] md:w-[230px] lg:w-[300px] xl:w-[350px] mx-2"
          ...
          >
            ...
            >
              ...
              <p
                className="md:inline hidden text-[26px] text-zinc-600"

...
export default function ElectionMovementFirstSection({
  ...
  return (
    <div className="w-full min-h-[700px] bg-white">
      {/* 상단 텍스트 */}
      <div className="flex flex-col items-start pl-32 mt-16">
      ...
      {/* pros & cons */}
      <div className="w-full max-w-[1500px] mx-auto my-16 px-32">
        {/* 헤더 */}
        <div className="flex items-center mb-7 mx-16">
          <h2 className="w-1/2 text-[#727272] text-3xl font-semibold text-left">
            타 선거기획사
          </h2>
          <h2 className="w-1/2 text-[#E61E2B] text-3xl font-semibold text-center">
            윈어스 자체제작
          </h2>
        </div>
        {/* 비교 항목 */}
        <div className="flex flex-col gap-6">
          {proscons.map((item, idx) => (
            <div key={idx} className="flex justify-center items-center ">
              {/* 왼쪽 cons */}
              <div className="w-[400px] text-[#727272] text-2xl text-left">
                {item.cons}
              </div>
              {/* 가운데 화살표 */}
      ...
      {/* featuress */}
      <div className="mx-32 my-16 bg-[#eee] h-[455px] rounded-3xl flex justify-center items-center gap-16">
        <motion.div

...
export default function FirstSectionFeatures() {
  return (
    <>
      ...
      {/* features-mobile */}
      <div className="lg:hidden flex my-8 md:my-16 py-12 px-6 bg-[#eee] max-w-screen h-fit flex-col justify-center items-center gap-12 ">
        <motion.div
          className="flex flex-row justify-start items-center max-w-[400px] w-full h-24 gap-6"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{
            duration: 0.5,
        ...
        >
          ...
          <p className="text-left text-sm sm:text-base font-[400] text-[#323232]">
            기존에 있는 곡에 가사를 붙이는 것에는 제약이 있었으나 자체제작으로{' '}
            <b>원하시는 메시지를</b> <b>완벽하게 전달</b> 할 수 있습니다.
          </p>
        </motion.div>
        <motion.div
          className="flex flex-row justify-start items-center max-w-[400px] w-full h-24 gap-6"
        ...
        >
          ...
          <p className="text-left text-sm sm:text-base font-[400] text-[#323232]">
            악기와 장비를 자체 보유하고, AI를 활용해 외주없이 내부에서 전 과정을
            소화해 <b>저렴한 가격에 높은 품질을</b> 자랑합니다.
          </p>
        </motion.div>
        <motion.div
          className="flex flex-row justify-start items-center max-w-[400px] w-full h-24 gap-6"
        ...
        >
          ...
          <p className="text-left text-sm sm:text-base font-[400] text-[#323232]">
            기존에 틀에서 벗어나 모션그래픽, 텍스트 애니메이션 등 다양한 기술을
            활용해 사진이 부족해도 <b>입체적인 MV 제작</b>이 가능합니다.
          </p>
        </motion.div>
      </div>
    </>

...
export default function FirstSection() {
  ...
  return (
    <div className="w-screen relative overflow-x-hidden flex flex-col items-start h-[900px] bg-[linear-gradient(to_bottom,#032FF4_60%,#fff_40%)]">
      {/* 상단 텍스트/버튼 등 */}
      <div className="flex w-full flex-col items-start pl-32 mt-24 ">
        ...
        <div className="flex justify-between w-full">
          ...
          <p className="pr-64 font-thin text-white">
            차별화된 감각과 아이디어로
            <br />
            상상에 생명을 불어넣습니다.
          </p>
